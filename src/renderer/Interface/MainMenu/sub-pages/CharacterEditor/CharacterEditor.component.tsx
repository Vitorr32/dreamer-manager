...
import { CHARACTERS_FOLDER, DATABASE_FOLDER} from 'renderer/shared/Constants';
...
export function CharacterEditor({}: IProps) {
    ...
    const onCharacterSubmit = async (): Promise<void> => {
        ...
        await CreateOrUpdateDatabaseJSONFile([DATABASE_FOLDER, CHARACTERS_FOLDER], updatedCharacter, database.packages[updatedCharacter.metadata.file.packageID]);
    };
