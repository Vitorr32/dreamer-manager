  ...
  getStepperContent(index: number) {
    switch (index) {
      case 0:
        return (
          <BasicInfoForm
            onBasicInfoSubmit={this.onBasicInfoSubmit.bind(this)}
      ...
      <div className="newtrait">
        ...
        <main className="newtrait__form">
          ...
          >
            <Step>
              <StepButton
                onClick={(_) => this.setState({ stepperIndex: 0 })}
            ...
            <Step>
              <StepButton
                onClick={(_) => this.setState({ stepperIndex: 1 })}
            ...
            <Step>
              <StepButton
                onClick={(_) => this.setState({ stepperIndex: 2 })}
            ...
            <Step>
              <StepButton
                onClick={(_) => this.setState({ stepperIndex: 3 })}
